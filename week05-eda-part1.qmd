...
```{r, message=FALSE}
ggplot(pokedata, aes(x = type_1, fill = type_1)) + # note that type_1 is categorical
...
[**How do you read a boxplot, and what are the different landmarks?**]{.underline}

-   **Median (middle line in the box)**

    -   Splits the dataset into two equal halves

    -   50% of the values are above it, 50% are below

-   **Box (the rectangle itself)**

    -   Bottom of the box = **Q1 (25th percentile)**

    -   Top of the box = **Q3 (75th percentile)**

    -   Together, the box covers the **middle 50%** of the data

-   **Interquartile Range (IQR)**

    -   The height of the box = Q3 − Q1

    -   Shows how spread out the middle half of the data is

-   **Whiskers (the lines above and below the box)**

    -   Extend out to the smallest and largest values **within 1.5 × IQR** of Q1 and Q3

    -   They give a sense of the overall spread (but stop before extreme outliers)

-   **Outliers (points beyond the whiskers)**

    -   Dots or circles plotted outside the whiskers

    -   Represent unusually high or low values compared to the rest
